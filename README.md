...
Ich empfehle die Installation von [TeX-Live auf Windows](https://tug.org/texlive/windows.html) und Visual Studio Code als Editor (einfach in PowerShell eingeben: `winget install Microsoft.VisualStudioCode`, oder manuell downloaden). Für VSCode empfehle ich die folgenden Extensions:
