# Project-FoSa
Recreating the source files to the formula collections from FLURUS - the student council of the aerospace degree program at the University of Stuttgart, Germany.
...
If you want to contribute, feel free to ask me for repo access!
...
- Useful notes have been added to each document, from CAS commands to equation numbers, all in accordance with the respective lecture.