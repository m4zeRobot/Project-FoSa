    ...
    \Tile{B3}{(A3.north east)}{\cellwidth}{\rowheight}
        {
            ...
            \begin{minipage}{0.46\cellwidth}
                ...
                \titlerm{Ruhezustand}
                \begin{equation*}
                    \qquad\frac{T_0}{T} = 1 + \frac{\kappa-1}{2}\,\text{Ma}^2~~\text{\color{NavyBlue}(9.19)}
                \end{equation*}
                \begin{equation*}
                    \frac{p_0}{p}=\left(\frac{T_0}{T}\right)^\frac{\kappa}{\kappa-1}=\left(1+\frac{\kappa-1}{2}\,\text{Ma}^2\right)^\frac{\kappa}{\kappa-1}
                \end{equation*}\\
                \vspace{-0.8mm}
                {\color{NavyBlue}(9.20a) \rotatebox[origin=c]{270}{$\Lsh$}}
                \begin{equation*}
                    \frac{\rho_0}{\rho}=\left(\frac{T_0}{T}\right)^\frac{1}{\kappa-1}=\left(1+\frac{\kappa-1}{2}\,\text{Ma}^2\right)^\frac{1}{\kappa-1}
                \end{equation*}\\
                \vspace{-1.8mm}
                {\color{NavyBlue}(9.20b) \rotatebox[origin=c]{270}{$\Lsh$}}
                \begin{equation*}
                    h_0 = h+\dfrac{V^2}{2} \Leftrightarrow T_0 = T+\dfrac{V^2}{2\,c_\text{p}}~~\text{\color{NavyBlue}(8.60)}
                \end{equation*}
            \end{minipage}%
            \vspace{2mm}
            \vline
            \begin{minipage}{0.50\cellwidth}
                \centering
                \titlerm{Krit. Zustand (Ma = 1)}
                \begin{equation*}
                    \frac{T^*}{T_0}=\frac{2}{\kappa+1}
                \end{equation*}%
                \vspace{-0.1mm}
                \begin{equation*}
                    \frac{p^*}{p_0}=\left(\frac{2}{\kappa+1}\right)^\frac{\kappa}{\kappa-1}
                \end{equation*}%
                \vspace{2mm}
                \begin{equation*}
                    \frac{\rho^*}{\rho_0}=\left(\frac{2}{\kappa+1}\right)^\frac{1}{\kappa-1}
                \end{equation*}\\
                \vspace{3.5mm}
                {\color{NavyBlue}\rotatebox[origin=c]{90}{$\Lsh$} (9.26)}\\
                \vspace{-6.5mm}
                \begin{equation*}
                    \frac{A}{A^*}=\frac{1}{\text{Ma}}\left[\frac{2}{\kappa+1}\left(1+\frac{\kappa-1}{2}\text{Ma}^2\right)\right]^\frac{\kappa+1}{2\,(\kappa-1)}
                \end{equation*}%
                \vspace{-4mm}
            \end{minipage}
            \setlength{\TileSep}{2mm}
    ...
    \Tile{B2}{(A2.north east)}{\cellwidth}{\rowheight}
        {
            ...
            \begin{minipage}{0.28\cellwidth-\TileSep}
                ...
                \vspace{-2.5mm}
                \begin{equation*}
                    \nu(\text{Ma}_2) = \nu(\text{Ma}_1) + \vartheta_{12}
                \end{equation*}
                \vspace{-2mm}
                {\color{NavyBlue}(9.75) \rotatebox[origin=c]{270}{$\Lsh$}}
            \end{minipage}%
            \vrule
            \begin{minipage}{0.72\cellwidth-\TileSep}
                \centering
                \vspace{-2.5mm}
                \begin{equation*}
                    \nu(\text{Ma}) = \sqrt{\frac{\kappa+1}{\kappa-1}}\,\arctan\left(\sqrt{\frac{\kappa-1}{\kappa+1}\,(\text{Ma}^2-1)}\right)-\arctan\left(\sqrt{\text{Ma}^2-1}\right)
                \end{equation*}
                \vspace{-4.5mm} \\
                \hspace{40mm} {\color{NavyBlue}(9.74) \rotatebox[origin=c]{270}{$\Lsh$}} \hspace*{10mm} {\color{Black!70}$\left(\nu_\text{max} = \text{130,454}^\circ\right)$}
            \end{minipage}
        }{0}{0}{1}{0}
    ...
    \Tile{B3}{(A3.north east)}{\cellwidth}{\rowheight}
        {
            ...
            \begin{minipage}{0.445\cellwidth}
                \centering
