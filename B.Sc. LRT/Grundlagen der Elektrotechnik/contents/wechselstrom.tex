    ...
    \Tile{C6}{(B6.north east)}{\cellwidth}{\rowheight}
        {
            ...
            \begin{minipage}{0.6\cellwidth-\TileSep}
                ...
                \titlerm{\scriptsize Pulsierender Anteil}\\ \vspace{-5mm}
                \begin{align*}
                    P_{2f}(t) &= -\frac{\hat i^2}{2\cdot\omega\cdot C}\cdot\sin\left(2\cdot(\omega\cdot t + \varphi_i)\right) \\
...
\setlength{\rowheight}{36mm}
    ...
    % B1) Erste Kachel absolut platzieren
    \setlength{\cellwidth}{140mm}
    \Tile{B1}{(A1.north east)}{\cellwidth}{\rowheight}
        {
            \vspace{-\TileSep}
            \titlerm{Darstellung in der komplexen Ebene}
        }{0}{0}{1}{0}
