...
\begin{table}[H]
    ...
    \begin{tabular}{l c c l}
        ...
        $d$         & $\left[\text{m}\right]$ & & Durchmesser (einer Spule, eines Kondensators oder eines elektrischen Leiters) \\[2.0ex]
        ...
        $f$         & $\left[\tfrac{1}{\text{s}}\right]$ & & Frequenz (Wechselstrom) \\[2.0ex]
        ...
        $U$, $u(t)$ & $\left[\text{V}\right]$ & & Elektrische Spannung (kleines $u$: zeitabhängig, bspw. bei Wechselspannung) \\[2.5ex]
    \end{tabular}
    }
\end{table}
