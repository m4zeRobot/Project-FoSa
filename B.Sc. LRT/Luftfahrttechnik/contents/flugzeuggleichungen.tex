...
\setlength{\rowheight}{22mm}
    ...
    \Tile{A2}{(A1.south west)}{\cellwidth}{\rowheight}
        {
            \titlerm{Auftriebsgleichung}\\ \vspace{-1.5mm}
            \begin{equation*}
            ...
            \begin{minipage}{0.52\cellwidth}
                ...
                \begin{align*}
                    X_\text{LOF} &= \frac{v_\text{LOF}^2}{2\,g\,\left(\frac{F}{G}-\mu\right)} \\
                                 &= 1,4\,\frac{G}{S\,\rho\,C_\text{A,max}\,g\,\left(\frac{F}{G}-\mu\right)}
                \end{align*}
                \vspace{3.3mm}
            \end{minipage}%
            \vrule
    ...
    \Tile{B6}{(A6.north east)}{\cellwidth}{\rowheight}
        {
            ...
            \begin{minipage}{0.50\cellwidth-\TileSep}
                \centering
                \vspace{1mm}
                \titlerm{Lastvielfaches}\\ \vspace{-2mm}
                \begin{equation*}
                    n_z = \frac{1}{\cos(\Phi)}
                \end{equation*}%
                \vspace{-1mm}
