    ...
    \Tile{A1}{([xshift=10mm,yshift=-18mm]current page.north west)}{\cellwidth}{\rowheight}
        {
            ...
            \begin{align*}
                A &= \frac{\rho_\infty}{2}\,U_\infty^2\,S\,C_\text{A} \\
                W &= \frac{\rho_\infty}{2}\,U_\infty^2\,S\,C_\text{W} \\
                M &= \frac{\rho_\infty}{2}\,U_\infty^2\,S\,C_\text{M}\,t
            \end{align*}
        }{0}{1}{1}{0}
    ...
    \Tile{B1}{(A1.north east)}{\cellwidth}{\rowheight}
        {
            ...
            \begin{align*}
                C_\text{A} &= \left(\frac{\text{d}C_\text{A}}{\text{d}\alpha}\right)_\text{2D}\,\alpha_e \\[1.0ex]
...
\input{content/skeletttheorie.tex}