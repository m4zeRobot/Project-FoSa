...
\begin{table}[H]
    ...
    \resizebox{\textwidth-20mm}{!}{\begin{tabularx}{249mm}{|l|Z|c|c|c|c|c|c|c|}
        ...
        \Cline{1-9}{\thickline}
        \xrowht[()]{\rowhght}\multirow{3}{*}{\begin{tabular}[l]{@{}l@{}}\\[\dimexpr(\rowhght/2)-10.8ex]Quelle, Senke\\[-2.6ex](Ergiebigkeit\\[-2.6ex]sei $Q \neq 0$)\end{tabular}} & \multirow{2}{*}{} & $\tfrac{Q}{2\pi}\,\ln(z)$ & $\tfrac{Q}{2\pi}\,\ln\left(\sqrt{x^2+y^2}\right)$ & $\tfrac{Q}{2\pi}\,\arctan\left(\tfrac{y}{x}\right)$ & $\tfrac{Q}{2\pi}\,\tfrac{x}{x^2+y^2}$ & $\tfrac{Q}{2\pi}\,\tfrac{y}{x^2+y^2}$ & $\tfrac{Q}{2\pi}\,\tfrac{1}{\sqrt{x^2+y^2}}$ & $0$ \\
        \cline{3-9}
        ...
        \Cline{1-9}{\thickline}
        \xrowht[()]{\rowhght}\multirow{3}{*}{\begin{tabular}[l]{@{}l@{}}\\[\dimexpr(\rowhght/2)-10.8ex]\scriptsize Potentialwirbel\\[-2.6ex](Zirkulation\\[-2.6ex]sei $\Gamma\neq 0$)\end{tabular}} & \multirow{2}{*}{} & $-i\,\tfrac{\Gamma}{2\pi}\,\ln(z)$ & $\tfrac{\Gamma}{2\pi}\,\text{arctan}\left(\tfrac{y}{x}\right)$ & $-\tfrac{\Gamma}{2\pi}\,\ln\left(\sqrt{x^2+y^2}\right)$ & $-\tfrac{\Gamma}{2\pi}\,\tfrac{y}{x^2+y^2}$ & $\tfrac{\Gamma}{2\pi}\,\tfrac{x}{x^2+y^2}$ & $0$ & $\tfrac{\Gamma}{2\pi}\,\tfrac{1}{\sqrt{x^2+y^2}}$ \\
        \cline{3-9}
        ...
        \Cline{1-9}{\thickline}
        \xrowht[()]{\rowhght}\multirow{3}{*}{\begin{tabular}[l]{@{}l@{}}\\[\dimexpr(\rowhght/2)-10.8ex]Dipol\\[-2.6ex](Auf der\\[-2.6ex]$x$-Achse)\end{tabular}} & \multirow{2}{*}{} & $-\tfrac{\mu}{2\pi}\,\tfrac{1}{z}$ & $-\tfrac{\mu}{2\pi}\,\tfrac{x}{x^2+y^2}$ & $\tfrac{\mu}{2\pi}\,\tfrac{y}{x^2+y^2}$ & $\tfrac{\mu}{2\pi}\,\tfrac{x^2-y^2}{\left(x^2+y^2\right)^2}$ & $\tfrac{\mu}{2\pi}\,\tfrac{2\,x\,y}{\left(x^2+y^2\right)^2}$ & $\tfrac{\mu}{2\pi}\,\tfrac{x}{\sqrt{\left(x^2+y^2\right)^3}}$ & $\tfrac{\mu}{2\pi}\,\tfrac{y}{\sqrt{\left(x^2+y^2\right)^3}}$ \\
        \cline{3-9}
        ...
        \Cline{1-9}{\thickline}
        \xrowht[()]{\rowhght}\multirow{3}{*}{\begin{tabular}[l]{@{}l@{}}\\[\dimexpr(\rowhght/2)-10.8ex]Dipol\\[-2.6ex](Auf der\\[-2.6ex]$y$-Achse)\end{tabular}} & \multirow{2}{*}{} & $-i\,\tfrac{\mu}{2\pi}\,\tfrac{1}{z}$ & $-\tfrac{\mu}{2\pi}\,\tfrac{y}{x^2+y^2}$ & $-\tfrac{\mu}{2\pi}\,\tfrac{x}{x^2+y^2}$ & $\tfrac{\mu}{2\pi}\,\tfrac{2\,x\,y}{\left(x^2+y^2\right)^2}$ & $-\tfrac{\mu}{2\pi}\,\tfrac{x^2-y^2}{\left(x^2+y^2\right)^2}$ & $\tfrac{\mu}{2\pi}\,\tfrac{y}{\sqrt{\left(x^2+y^2\right)^3}}$ & $-\tfrac{\mu}{2\pi}\,\tfrac{x}{\sqrt{\left(x^2+y^2\right)^3}}$ \\
        \cline{3-9}
...
\setlength{\rowheight}{28mm}
    ...
    \Tile{A3}{(A2.south west)}{\cellwidth}{\rowheight}
        {
            \titlerm{Einfache Staupunkte}\\[1.0ex]
