    ...
    \Tile{B1}{(A1.north east)}{\cellwidth}{\rowheight}
        {
            ...
            \begin{minipage}[t]{0.5\cellwidth-\TileSep}
                \centering
                \myul{Plötzliche Verengung}\\ \vspace{-4mm}
                \begin{equation*}
                    \Delta p_\text{Eng} = \frac{\rho}{2}\,\overline{u}_2^2\left[1-\left(\frac{A_2^*}{A_1}\right)^2\right]
                \end{equation*}
                \myul{Druckverlustbeiwert}\\ \vspace{-3mm}
                \begin{equation*}
                    \zeta_f = \left(\frac{A_2}{A_2^*}-1\right)^2 = \left(\frac{1}{\mu}-1\right)^2
                \end{equation*}
            \end{minipage}
        }{0}{0}{1}{0}
...
\setlength{\rowheight}{25mm}
    ...
    \Tile{C3}{(B3.north east)}{\cellwidth}{\rowheight}
        {
            \vspace{-\TileSep}
            \titlerm{Druckverlustbeiwert}\\ \vspace{-1mm}
            \begin{equation*}
