    ...
    \Tile{A6}{(A5.south west)}{\cellwidth}{\rowheight}
        {
            ...
            \begin{tabular}{l|c|c|c|c}
                ...
                \xrowht[()]{5mm} \cellcolor{Gray!40}Dynamischer Druck & $p_\text{dyn}$                      & $p$                             & $p$                                            & $p$                                         \\ \hline
                \xrowht[()]{5mm} \cellcolor{Gray!40}Dynamischer Druck & $p_0$, $p_\text{t}$, $p_\text{ges}$ & $p_0 = p + \frac{\rho}{2}\,v^2$ & \multicolumn{2}{c}{$p_0 = p + \frac{\rho}{2}\,v^2 + \Delta p_\text{komp.} = p\left(1 + \frac{\kappa-1}{2}\,\mathrm{Ma}^2\right)^{\frac{\kappa-1}{\kappa}}$} \\ \hline
                \xrowht[()]{5mm} \cellcolor{Gray!40}Pitotdruck        & $p_\text{pitot}$                    & $p_\text{pitot} = p_0$          & $p_\text{pitot} = p_0$                         & $p_\text{pitot} \leq p_0$                   \\ \hline
                \xrowht[()]{5mm} \cellcolor{Gray!40}Staudruck         & $q$                                 & $p_0 - p = \frac{\rho}{2}\,v^2$ & $p_0 - p > \frac{\rho}{2}\,v^2$                &
            \end{tabular}
        }{0}{0}{0}{0}
