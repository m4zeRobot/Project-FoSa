...
\setlength{\rowheight}{100mm}
    ...
    \Tile{A1}{([xshift=10mm, yshift=-175mm]current page.north west)}{\cellwidth}{\rowheight}
        {
            \vspace{-\TileSep}
            \titlerm{Grenzfläche (Rotierender Zylinder)}\\ \vspace{-1mm}
            ...
            \titlerm{Hydrostatischer Auftrieb}\\ \vspace{2mm}
    ...
    \Tile{B1}{(A1.north east)}{\cellwidth}{\rowheight}
        {
            \vspace{-\TileSep}
            \titlerm{Flüssigkeitssäule}\\ \vspace{2mm}
            \begin{minipage}{0.5\cellwidth-\TileSep}
                \centering
                \vspace{-2.5mm}
                \begin{equation*}
            ...
            \begin{minipage}[t]{0.55\cellwidth-\TileSep}
                ...
                \begin{align*}
                    p(z)    &= p_0\left(1-\frac{\kappa-1}{\kappa}\,\frac{\rho_0\,g}{p_0}\,x\right)^{\frac{\kappa}{\kappa-1}}    \\
                    \rho(z) &= \rho_0\left(1-\frac{\kappa-1}{\kappa}\,\frac{\rho_0\,g}{p_0}\,x\right)^{\frac{\kappa}{\kappa-1}} \\[0.5ex]
                    T(z)    &= T_0\left(1-\frac{\kappa-1}{\kappa}\,\frac{\rho_0\,g}{p_0}\,x\right)
                \end{align*}%
                \vspace{-1mm}
            \end{minipage}
        }{0}{0}{0}{0}
